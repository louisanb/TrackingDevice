...
#define TILT_LED 1        // GJC:Lights the TILT LED when > TILT_ANGLE degrees of displacement
#define TILT_OUTPUT 1     // GJC:Outputs TRxxx/TPxxx when TILT_ANGLE out of spc to Serial port
#define TILT_ANGLE 10/2   // GJC:-14 to +14 off vertical, any axis.. not sure why the magnetometer read 7 degrees at 14 actual degrees..
boolean blnInTilt_Roll = false;
boolean blnInTilt_Pitch = false;
float fltMax_Roll = 0.0;
float fltMax_Pitch = 0.0;
const int TILT_THRESHOLD = 10;  // # of out of spec readings continuously to trigger out of spec this prevens spurious readings causing a call home
signed int cntRoll = TILT_THRESHOLD;
int cntPitch = TILT_THRESHOLD;
...
#define MAGNETIC_DECLINATION -13.0    // corrects magnetic bearing to true north (GJC:originally 4.0)
